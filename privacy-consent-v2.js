(function () {
    ...
    style.textContent = `
      ...
      @media(max-width:600px){#neo-consent{left:8px;right:8px;bottom:76px;padding:13px;font-size:12px}.neo-consent-actions{display:grid;grid-template-columns:1fr}}
    `;
    ...
    function init() { buildModal(); if (!read()) buildBanner(); }
