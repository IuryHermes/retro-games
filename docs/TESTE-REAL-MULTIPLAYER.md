...
- Abrir `/multiplayer-diagnostics.html` em cada aparelho e copiar o relatório.
...
8. Confirmar no GA4 os eventos `multiplayer_hub_open`, `multiplayer_auth_required`, `multiplayer_room_created` e `multiplayer_joined`, sem dados pessoais.
...
Registre data, aparelhos, versões dos navegadores, jogo, resultado e relatório de diagnóstico em uma issue ou no histórico operacional do projeto.
