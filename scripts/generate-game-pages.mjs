...
for (const system of systems) {
  ...
  for (const game of unique) {
    ...
    const cover = coverName ? `${coverBase}systems/${system}/capas/${encodeURIComponent(coverName)}${system === 'neogeo' ? '?v=20260831-covers2' : ''}` : `${site}/assets/imagens-videos/logo-discord.gif`;
    ...
    const onlineDetail = maxPlayers > 1 ? `ATÉ ${maxPlayers} JOGADORES` : 'SALA E ESPECTADOR';
    const multiplayerAction = `<a class="online" href="/?multiplayer=1">⚔ JOGAR ONLINE <small>${onlineDetail} · CADASTRO GRÁTIS</small></a>`;
...
await writeFile(join(root,'sitemap-static.xml'), `<?xml version="1.0" encoding="UTF-8"?><urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9"><url><loc>${site}/</loc><changefreq>daily</changefreq><priority>1.0</priority></url><url><loc>${site}/coletaneas.html</loc><changefreq>weekly</changefreq><priority>0.8</priority></url><url><loc>${site}/social.html</loc><changefreq>daily</changefreq><priority>0.8</priority></url><url><loc>${site}/ofertas.html</loc><changefreq>daily</changefreq><priority>0.7</priority></url><url><loc>${site}/apoie.html</loc><changefreq>monthly</changefreq><priority>0.7</priority></url></urlset>`);
