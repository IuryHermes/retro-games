...
assert.match(guest, /const n64Stick = \{ 4: 19, 5: 18, 6: 17, 7: 16 \}/);
assert.match(guest, /inputValue = inputValue \? 0x7fff : 0/);
...
console.log('multiplayer client and room: 97 checks passed');
