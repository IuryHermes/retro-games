...
assert.match(worker, /recognition: recognitionFor\(candidate\.uid\)/);
assert.match(worker, /recognition: recognitionFor\(account\.uid\)/);
...
console.log('account-native visual support recognition: 30 checks passed');
